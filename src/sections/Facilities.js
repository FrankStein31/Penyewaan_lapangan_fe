    ...
    const facilities = [
        {
            ...
            icon: (
                <svg className="w-12 h-12 text-green-400 transition-colors duration-300 group-hover:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            glowColor: 'from-orange-500/10 to-red-600/20'
        },
        {
            ...
            glowColor: 'from-green-500/10 to-cyan-600/20'
        },
        {
            name: 'Ruang Yoga',
                    ...
                    {facilities.map((facility, index) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <h3 className="mb-3 text-xl font-bold text-white transition duration-300 group-hover:text-green-400">
                                    {facility.name}
                                </h3>
