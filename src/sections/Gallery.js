    ...
    const galleryImages = [
        {
            ...
            alt: 'Lapangan Basket',
            category: 'Fasilitas',
            highlightColor: 'from-green-500/10 to-green-600/20'
        },
        {
            src: '/images/renang.jpg',
            alt: 'Kolam Renang',
            category: 'Fasilitas',
            highlightColor: 'from-orange-500/10 via-red-500/10 to-red-600/20'
        },
        {
            src: '/images/kebugaran.jpg',
            alt: 'Pusat Kebugaran',
            category: 'Fasilitas',
            highlightColor: 'from-blue-500/10 to-indigo-600/20'
        },
        {
        ...
        },
        {
            ...
            alt: 'Kelas Yoga',
            category: 'Event',
            highlightColor: 'from-green-500/10 to-teal-600/20'
        },
        {
            ...
            <div className="container relative z-10 px-4 mx-auto sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <h2 className="mb-4 text-3xl font-bold text-center text-white md:text-4xl lg:text-5xl">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-cyan-400">Sport Center</span> Gallery
                    </h2>
                    ...
                    {galleryImages.map((image, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col items-start justify-end p-6 text-white transition-opacity duration-500 opacity-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent group-hover:opacity-100">
                                <span className="px-3 py-1 mb-2 text-xs font-medium text-green-300 uppercase rounded-full bg-green-900/50 backdrop-blur-sm">
                                    {image.category}
                                </span>
                ...
                <div className="mt-12 text-center">
                    <button className="px-8 py-3 font-medium text-white transition-all duration-300 rounded-lg bg-gradient-to-r from-green-500 to-cyan-500 hover:from-green-600 hover:to-cyan-600 hover:shadow-lg hover:shadow-green-500/30">
